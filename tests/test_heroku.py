...
#         result = requests.get('https://instagram-data-monitor.herokuapp.com/')
...
#         # Envia uma requisição HTTP GET para a aplicação
#         result = requests.get('https://instagram-data-monitor.herokuapp.com/actor/example')

#         self.assertEqual(result.content.decode("utf-8") , "actor name : example")

#     def test_get_actor_name_json_example(self):
#         # Envia uma requisição HTTP GET para a aplicação
#         result = requests.get('https://instagram-data-monitor.herokuapp.com/actorjson/example')
